...
output_path = os.path.join(output_dir, "T_U5_L5_MDOF_Modal_Analysis.ipynb")
...
# Cell 3: Theory - Modal Decomposition
notebook["cells"].append({
    "cell_type": "markdown",
    "metadata": {},
    "source": [
...
# Cell 4: Example 1 - Modal Decomposition
notebook["cells"].append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
# Cell 6: Example 2 - Forced Response
notebook["cells"].append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
# Cell 7: Example 3 - Time Domain Forced Response
notebook["cells"].append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
print("=" * 60)
print("Unit 5 Lecture 5 Created Successfully!")
print("=" * 60)
print(f"\nFile: {output_path}")
print(f"\nNotebook structure:")
...
print(f"\nContent:")
print(f"  Part A: Modal decomposition theory + Example 1 (free vibration)")
print(f"  Part B: Forced response theory + Example 2 (FRF sweep)")
print(f"  Example 3: Time-domain resonance build-up")
print(f"\nDuration: ~90 minutes")
print(f"\nReady to test!")
